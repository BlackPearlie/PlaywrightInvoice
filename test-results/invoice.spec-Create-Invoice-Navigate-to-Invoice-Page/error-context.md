      ...
      - generic [ref=e66]:
        ...
        - generic [ref=e70]:
          ...
          - generic [ref=e77]:
            ...
            - textbox "Enter client address..." [ref=e79]: 123 Fake Street
          - generic [ref=e80]:
            - generic [ref=e81]:
...
```ts
  ...
  46  |        this.addCourseButton = page.locator('xpath=//button[contains(.,"➕ Add Course")]');
  ...
  107 |         console.log(this.addCourseButton.getByText('➕ Add Course'));
  108 |         }
